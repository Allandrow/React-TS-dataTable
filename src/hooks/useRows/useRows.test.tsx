...
const headers: Header[] = [
  {
    ...
    handleSortEvent: null,
  },
  { id: 'lastName', text: 'Last Name', classNames: [], handleSortEvent: null },
  { id: 'dateOfBirth', text: 'Date of Birth', classNames: [], handleSortEvent: null },
  { id: 'startDate', text: 'Start Date', classNames: [], handleSortEvent: null },
  { id: 'department', text: 'Department', classNames: [], handleSortEvent: null },
  { id: 'street', text: 'Street', classNames: [], handleSortEvent: null },
  { id: 'city', text: 'City', classNames: [], handleSortEvent: null },
  { id: 'state', text: 'State', classNames: [], handleSortEvent: null },
  { id: 'zipCode', text: 'Zip Code', classNames: [], handleSortEvent: null },
]
